...
export type SystemPurposeId = 'Catalyst' | 'Custom' | 'Designer' | 'Developer' |   'Executive' | 'Generic' | 'Scientist' | 'YouTubeTranscriber';
...
`+"```",
    ...
    examples: ['Plot a Chart of NVDA and TESLA stock price change YTD using yfinacne and save as stock_price.png', 'Create a simple pomodoro app using streamlit. Add a progress bar to show time taken.', 'Print out the fibonacci series'],
